...
- Project number: `25`
- Project title: `ENV Lens`
- Project URL: https://github.com/users/gvastethecreator/projects/25
- Local root: `.scratch/vscode-env-lens/`
...
- Spec: `.scratch/vscode-env-lens/spec.md` (`PRD.md` remains compatible).
- Ticket mirrors: `.scratch/vscode-env-lens/issues/<NN>-<slug>.md`. Never under `docs/`.
- Rejected requests: `.scratch/vscode-env-lens/out-of-scope/<concept>.md`.
...
GitHub project: https://github.com/users/gvastethecreator/projects/25
...
5. Add the Issue to Project `25` under `gvastethecreator`.
...
```powershell
gh issue view <number> -R gvastethecreator/vscode-env-lens --json number,title,state,body,labels,assignees,comments,updatedAt,url
gh project view 25 --owner gvastethecreator --format json
gh project field-list 25 --owner gvastethecreator --format json
gh project item-list 25 --owner gvastethecreator --limit 200 --format json --field Status
gh project item-add 25 --owner gvastethecreator --url <issue-url>
gh project item-edit 25 --owner gvastethecreator --url <issue-url> --field Status --value Todo
gh issue create -R gvastethecreator/vscode-env-lens --title <title> --body-file <path> --parent <parent-number> --blocked-by <number,number>
gh issue edit <issue-number> -R gvastethecreator/vscode-env-lens --parent <parent-number> --add-blocked-by <number>
```
