...
**Catch `.env` mistakes before they break your app**
...
1) Clone [gvastethecreator/vscode-env-lens](https://github.com/gvastethecreator/vscode-env-lens), then run `pnpm install`.
2) Press F5 (`Run Extension`).
3) Open a `.env` file in the Extension Host window.
