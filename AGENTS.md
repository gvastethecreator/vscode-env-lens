...
VS Code extension (`gvastethecreator.env-lens`). pnpm. TypeScript in `src/`. esbuild writes `dist/extension.js`.
...
- Do not write tickets under `docs/`. Local tickets: `.scratch/vscode-env-lens/issues/`.
